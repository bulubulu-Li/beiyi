...
def build_single_pos_sample(edf_path, raw_df, seiz_time_df, date, patient_name):
    ...
    root_path = f'/mnt/data1/user/kenan/bei_yi_70/{date}/pos_{time_window_size}'
...
def deal_all_patients():
    ...
    #patient_root_path = '/mnt/data1/share_data/70个发作期-北大/2.E-210460陈柳妍'

    all_patient_root_path = '/mnt/data1/share_data/70个发作期-北大'
    ...
    for edf_path in all_edf_path_list:
        ...
        try:
            ...
            if seiz_time_df.shape[0] > 0:
                build_single_pos_sample(edf_path, raw_df, seiz_time_df, date, patient_name)
            #else:
